...
module.exports = function(grunt) {
		...
		.initConfig({
			...
			watch: {
				...
				sassDocs: {
					...
					tasks: [ 'media-sass-sass:docs' ]
				},
				sass: {
					files: [ 'src/**/*.scss' ],
					tasks: [ 'media-sass-sass:dist', 'cssmin:dist', 'usebanner:dist', 'copy:distToDocs' ]
				},
				jsDocs: {
	...
	// tasks
	grunt.registerTask('dist', [ 'clean:dist', 'media-sass-sass:dist', 'autoprefixer', 'concat:dist', 'cssmin:dist', 'copy:distImages', 'usebanner:dist', 'uglify:dist', 'copy:readme' ]);

	grunt.registerTask('docs', [ 'dist', 'clean:docs', 'assemble', 'media-sass-sass:docs', 'copy:docsAssets', 'copy:distToDocs', 'zip' ]);
