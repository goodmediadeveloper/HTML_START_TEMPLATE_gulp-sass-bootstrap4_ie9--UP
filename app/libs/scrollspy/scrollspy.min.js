        ...
        scrollspy: function (options) {
            ...
            var add = function (ex1, ex2) {
                ...
                for (var elements = [], i = 0; i < links.length; i++) {
                    var link = links[i], hash = $(link).attr("href"), element = $(hash);
                    if (element.length > 0) {
                ...
                for (var element = this, container = $(options.container), links = $(element).find("a"), i = 0; i < links.length; i++) {
                    ...
                    $(link).on("click", function (e) {
                        ...
                        if ($target.length > 0) {
                            ...
                            options.animate ? $("html, body").animate({scrollTop: top}, options.duration) : window.scrollTo(0, top), e.preventDefault()
                        }
                    })
                }
                resetClasses(links);
                var elements = findElements(links), trackChanged = function () {
